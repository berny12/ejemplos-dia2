...
import com.synergyj.cursos.webservices.sib.document.ImageBookSearchServiceImpl;
 ...
 * @version 1.0
 */
public class ImageBookSearchServicePublisher {

	/**
	 * Logger para todas las instancias de la clase
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(ImageBookSearchServicePublisher.class);
	...
	public static void main(String[] args) {
		...
		String url = "http://127.0.0.1:9878/imageBookSearchService?wsdl";

		logger.debug("Publicando WS estilo document en  " + url);
		logger.debug("Para terminar presione Ctrl + C");
		Endpoint.publish(url, new ImageBookSearchServiceImpl());
