 ...
 */
package com.synergyj.cursos.webservices.lab3;
...
import com.synergyj.cursos.webservices.sib.document.OrdenCompraServiceImpl;
 ...
 * @version 1.0
 */
public class OrdenCompraDocumentPublisher {

	/**
	 * Logger para todas las instancias de la clase
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(OrdenCompraDocumentPublisher.class);
	...
	public static void main(String[] args) {
		...
		String url = "http://127.0.0.1:9878/ordenCompraService?wsdl";
